...
# Adjust fig for proper viewing and saving
...
# Create log spaced bins with 100 bins
...
# Replace TAXP with converted values from PDF
for y in range(1,69):
